    ...
    switch (currentRole) {
      ...
      case 'dosen':
        return [
          ...
          { id: 'perwalian', label: 'Perwalian KRS', icon: UserCheck },
          { id: 'nilai', label: 'Input Nilai Kuliah', icon: GraduationCap },
          { id: 'presensi', label: 'Presensi Mahasiswa', icon: CheckSquare }
        ];
      case 'admin':
        return [
